const ramos = [
  /* PRIMER AÑO */
  { id: "DP", nombre: "Desarrollo personal", semestre: "1º", requisitos: [] },
  { id: "FM1", nombre: "Fundamentos de matemática", semestre: "1º", requisitos: [] },
  { id: "QI", nombre: "Química para ingeniería", semestre: "1º", requisitos: [] },
  { id: "FP1", nombre: "Fundamentos de programación", semestre: "1º", requisitos: [] },
  { id: "DI", nombre: "Desafíos de ingeniería", semestre: "1º", requisitos: [] },

  { id: "FF", nombre: "Fundamentos de física", semestre: "2º", requisitos: [] },
  { id: "CD", nombre: "Cálculo diferencial", semestre: "2º", requisitos: ["FM1"] },
  { id: "A", nombre: "Álgebra", semestre: "2º", requisitos: ["FM1"] },
  { id: "IIE", nombre: "Ingeniería, innovación y emprendimiento", semestre: "2º", requisitos: ["DI"] },
  { id: "P", nombre: "Programación", semestre: "2º", requisitos: ["FP1"] },

  /* SEGUNDO AÑO */
  { id: "CIS", nombre: "Cálculo integral y series", semestre: "3º", requisitos: ["CD"] },
  { id: "AL", nombre: "Álgebra lineal", semestre: "3º", requisitos: ["A"] },
  { id: "FMEC", nombre: "Física mecánica", semestre: "3º", requisitos: ["FF","CD"] },
  { id: "GD", nombre: "Gestión de datos de salud", semestre: "3º", requisitos: ["FP1"] },
  { id: "BC", nombre: "Biología celular", semestre: "3º", requisitos: [] },
  { id: "TI1", nombre: "Taller de integración perfil sello UV 1", semestre: "3º", requisitos: ["FP1"] },

  { id: "CVV", nombre: "Cálculo en varias variables", semestre: "4º", requisitos: ["CIS","AL"] },
  { id: "EDO", nombre: "Ecuaciones diferenciales ordinarias", semestre: "4º", requisitos: ["CIS","AL"] },
  { id: "FE", nombre: "Física electromagnetismo", semestre: "4º", requisitos: ["CIS","FMEC"] },
  { id: "EC", nombre: "Estadística computacional", semestre: "4º", requisitos: ["FP1","CD"] },
  { id: "FS1", nombre: "Fisiología de sistemas I", semestre: "4º", requisitos: ["BC"] },
  { id: "I", nombre: "Inglés", semestre: "4º", requisitos: ["DP"] },
  ...
  { id: "FCO", nombre: "Física, calor y ondas", semestre: "5º", requisitos: ["CIS","FMEC"] },
  { id: "MNO", nombre: "Métodos numéricos y optimización", semestre: "5º", requisitos: ["AL","GD"] },
  { id: "FS2", nombre: "Fisiología de sistemas II", semestre: "5º", requisitos: ["BC"] },
  { id: "TI2", nombre: "Taller de integración perfil sello UV 2", semestre: "5º", requisitos: ["GD"] },

  { id: "ED", nombre: "Electrónica digital", semestre: "6º", requisitos: ["FP1","EA"] },
  { id: "LABED", nombre: "Laboratorio de electrónica digital", semestre: "6º", requisitos: ["FP1","LABEA"] },
  { id: "BM", nombre: "Mediciones biomédicas", semestre: "6º", requisitos: ["BC","EA"] },
  { id: "GI", nombre: "Gráfica en ingeniería", semestre: "6º", requisitos: ["FM1"] },
  { id: "GOS", nombre: "Gestión de organizaciones de salud", semestre: "6º", requisitos: ["GD"] },
  { id: "SPSS", nombre: "Salud pública y sistemas de salud", semestre: "6º", requisitos: ["TI2","GD"] },
  ...
  { id: "RDYC", nombre: "Redes de datos y comunicaciones", semestre: "7º", requisitos: ["GD"] },
...
// Código de creación de botones y progreso (igual que el script anterior)
